...
//        exercises = mViewModel.getRoutineExercises();
...
//                    Log.d("RoutineDetailFragment", "====== Routine Exercise Details (END) ======");
                    ...
                    // Ensure data is completely loaded
                    if (detailDTOs.stream().anyMatch(dto -> dto.getExercise() == null)) {
                        Toast.makeText(getContext(), "Some exercises failed to load. Please try again.", Toast.LENGTH_SHORT).show();
                        return;
                    }
